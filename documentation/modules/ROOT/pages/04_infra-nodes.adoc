...
* cluster-zbwlg-cbgq7-private-us-east-2a -> 既存の Worker 用 MachineSets から取得（ここでは cluster-8trtb-rlgsx-private-us-east-2b）

* us-east-2a -> 既存の Worker 用 MachineSets から取得（ここでは us-east-2b）
* us-east-2 -> $REGION
...
cluster-zbwlg-cbgq7-infra-us-east-2a    1         1         1       1           49m
