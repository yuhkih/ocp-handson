...
NOTE: https://access.redhat.com/documentation/ja-jp/red_hat_build_of_node.js/20/html-single/node.js_runtime_guide/index#developing-and-deploying-a-nodejs-application_introduction-to-application-development-with-runtime[サンプルアプリケーションの作成ガイド]も参考にしてください。
