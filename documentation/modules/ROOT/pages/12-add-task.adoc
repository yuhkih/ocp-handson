...
最終的には、下記のステップがタスクで自動実行されます（ここでは実施不要です）。
...
[source,bash]
----
oc login -u admin -p <パスワード> <OpenShift API :6443>
...
export OCP_TOKEN=sha256~11hnNe5tef3GOD84R6hNZtzTNjqAERZ722l2KvDj4r8
----
+
