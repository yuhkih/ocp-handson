...
* https://www.redhat.com/en/blog/a-guide-to-controller-ingress-for-azure-red-hat-openshift[A Guide to Ingress Controllers for Azure Red Hat OpenShift] (プライベートなAROクラスターの作成とアプリケーションの外部公開方法を紹介したブログ)
