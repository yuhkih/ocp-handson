...
AWSコンソールから、ROSAクラスター作成に必要な
https://docs.aws.amazon.com/rosa/latest/userguide/security-iam-awsmanpol.html#security-iam-awsmanpol-rosamanagedpolicies-account-roles[IAMロール]
が作成されていることを確認できます。
...
ROSA HCPクラスターの
https://www.redhat.com/en/topics/containers/what-is-a-kubernetes-operator[Operator]が、専用の
https://docs.aws.amazon.com/rosa/latest/userguide/security-iam-awsmanpol.html#security-iam-awsmanpol-rosamanagedpolicies-operator-roles[IAMロール]
を作成して利用するために必要となる、OpenID Connectの設定を作成します。
