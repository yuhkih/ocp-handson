...
https://marketplace.visualstudio.com/items?itemName=AmazonWebServices.aws-toolkit-vscode&ssr=false#version-history[AWS Toolkit拡張機能]
のファイルをダウンロードして、Dev Spacesの各Workspaceに手動でインポートすることで、
